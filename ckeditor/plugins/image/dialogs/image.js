		...
		return {
			...
			onShow : function()
			{
				...
				var editor = this.getParentEditor(),
                    ...
                    rel = element && element.getAscendant( 'rel'); /* WB change */
                ...
                if (rel) this.setupContent( REL, rel ); /* WB change */
			...
			onOk : function()
			{
                ...
                this.commitContent( REL, this.linkElement ); /* WB change */
